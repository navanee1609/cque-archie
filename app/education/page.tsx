...
const features = [
  {
    id: 1,
    title: "Effortless Teacher Substitute Management",
    description:
  ...
  {
    id: 2,
    title: "Seamless Substitute Matching",
    description:
  ...
  {
    id: 3,
    title: "Proactive Planning for Better Outcomes",
    description:
  ...
  {
    id: 4,
    title: "Effortless Communication and Coordination",
    description:
  ...
  {
    id: 5,
    title: "Streamlined Operations, Maximum Impact",
    description:
          ...
          <div className="lg:w-3/4 pr-4 pl-4 text-center">
            <h1 className="fs-48 fw-600 py-5 text-[#3f559e]">
              ...
              <span className="font-medium text-black">
                {" "}
                Revolutionize Teacher Substitute Management with CQUE.AI
              </span>
            </h1>
          ...
          <div className="grid items-center grid-cols-1 gap-y-8 lg:grid-cols-2 gap-x-16 xl:gap-x-24">
            ...
            <div className="space-y-6 lg:space-y-8">
              ...
              <p className="text-lg text-gray-600 font-medium text-center lg:text-left">
                Enhance your school's efficiency today with AI-powered
                management tools.
                <br />
              </p>
            </div>
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-2xl font-bold leading-tight text-black sm:text-3xl lg:text-3xl animate__animated animate__fadeIn">
              Join Thousands of Educators Enhancing Their Classroom Experience
              with Cque AI
            </h2>
          </div>
            ...
            <div className="grid grid-cols-1 gap-12 lg:gap-16 sm:grid-cols-2">
              <div className="flex items-start p-6 transition-all duration-500 ease-in-out transform bg-white rounded-lg shadow-sm hover:scale-105 hover:shadow-lg hover:border">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-4 text-base font-medium text-black">
                    Managing teacher absences is simple with Cque AI, which
                    streamlines substitute management to keep classrooms
                    productive and students thriving.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-6 transition-all duration-500 ease-in-out transform bg-white rounded-lg shadow-sm hover:scale-105 hover:shadow-lg hover:border">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-4 text-base font-medium text-black">
                    Say goodbye to last-minute scrambles—our AI swiftly matches
                    the best substitutes based on expertise, location, and
                    availability, ensuring every classroom runs smoothly.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-6 transition-all duration-500 ease-in-out transform bg-white rounded-lg shadow-sm hover:scale-105 hover:shadow-lg hover:border">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-4 text-base font-medium text-black">
                    Anticipate staffing gaps before they occur. Cque AI analyzes
                    historical trends and schedules to forecast potential needs,
                    empowering you to stay ahead with proactive substitute
                    planning.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-6 transition-all duration-500 ease-in-out transform bg-white rounded-lg shadow-sm hover:scale-105 hover:shadow-lg hover:border">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-4 text-base font-medium text-black">
                    From notifying substitutes to confirming assignments, Cque
                    AI automates the communication process, reducing
                    administrative burdens and ensuring a seamless connection
              ...
              <div className="flex items-start p-6 transition-all duration-500 ease-in-out transform bg-white rounded-lg shadow-sm hover:scale-105 hover:shadow-lg hover:border">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-4 text-base font-medium text-black">
                    Let Cque AI take care of the complexities of substitute
                    management, so your focus remains on what matters
                    most—ensuring students receive uninterrupted education.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-6xl">
              <div className="max-w-2xl mx-auto text-left sm:text-center">
                <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl">
                  Transform how you manage teacher absences with AI-powered
                  efficiency!
                </h2>
                {/* <p className="max-w-xl mx-auto mt-4 text-lg font-medium leading-relaxed text-gray-600">
                Start today and experience stress-free substitute management!
                </p> */}
              </div>
