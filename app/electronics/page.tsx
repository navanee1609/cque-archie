...
<div className="container mx-auto sm:px-4 ptb-120">
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-black sm:text-4xl lg:text-5xl">Transforming Customer Support with AI</h2>
            <p className="mt-4 text-lg font-medium text-black">Empowering businesses with intelligent, efficient, and scalable solutions for a seamless support experience.</p>
        </div>
        <div className="grid grid-cols-1 gap-12 text-center sm:grid-cols-2 md:grid-cols-3 lg:gap-y-16">
            <div>
                <div className="relative flex items-center justify-center mx-auto">
                    <i className="text-blue-600 fas fa-robot text-4xl"></i>
                </div>
                <h3 className="mt-8 text-lg font-semibold text-black">Effortless Start to Your Support Journey</h3>
                <p className="mt-4 text-base font-medium text-black">Our AI assistant understands your needs and recommends the right devices, upgrades, or accessories, making your buying process simple and seamless.</p>
            </div>

            <div>
                <div className="relative flex items-center justify-center mx-auto">
                    <i className="text-orange-600 fas fa-tools text-4xl"></i>
                </div>
                <h3 className="mt-8 text-lg font-semibold text-black">Preliminary Guidance for Informed Decisions</h3>
                <p className="mt-4 text-base font-medium text-black">Quickly identify issues and provide step-by-step guidance for troubleshooting, setup, or connectivity fixes—getting you back on track effortlessly.</p>
            </div>

            <div>
                <div className="relative flex items-center justify-center mx-auto">
                    <i className="text-green-600 fas fa-headset text-4xl"></i>
                </div>
                <h3 className="mt-8 text-lg font-semibold text-black">Efficient Issue Resolution</h3>
                <p className="mt-4 text-base font-medium text-black">AI chatbots resolve common issues by guiding customers through troubleshooting steps and seamlessly escalating complex cases to human agents.</p>
            </div>

            <div>
                <div className="relative flex items-center justify-center mx-auto">
                    <i className="text-purple-600 fas fa-comments text-4xl"></i>
                </div>
                <h3 className="mt-8 text-lg font-semibold text-black">Handling Routine Queries</h3>
                <p className="mt-4 text-base font-medium text-black">AI automates responses to frequently asked questions, such as product details, shipping times, and return policies, freeing up human agents for complex tasks.</p>
            </div>

            <div>
                <div className="relative flex items-center justify-center mx-auto">
                    <i className="text-gray-600 fas fa-chart-line text-4xl"></i>
                </div>
                <h3 className="mt-8 text-lg font-semibold text-black">Cost Savings and Scalability</h3>
                <p className="mt-4 text-base font-medium text-black">AI can scale effortlessly to handle large customer inquiries during peak periods, reducing costs while maintaining quality support.</p>
            </div>
        </div>
    </div>
</section>
