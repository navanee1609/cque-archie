          ...
          <div className="grid items-center grid-cols-1 gap-y-8 lg:grid-cols-2 gap-x-16 xl:gap-x-24">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 font-medium text-center lg:text-left">
                Enhance your operations today with AI-powered electronics
                management tools.
                <br />
              </p>
            </div>
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-2xl font-bold leading-tight text-black sm:text-3xl lg:text-3xl animate__animated animate__fadeIn">
              Join Thousands of Tech Enthusiasts Revolutionizing Their
              Electronics Experience with Cque AI
            </h2>
          </div>
            ...
            <div className="grid grid-cols-1 gap-12 lg:gap-16 sm:grid-cols-2">
              <div className="flex items-start p-6 transition-all duration-500 ease-in-out transform bg-white rounded-lg shadow-sm hover:scale-105 hover:shadow-lg hover:border">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-4 text-base font-medium text-black">
                    Our AI assistant understands your needs and recommends the
                    right devices, upgrades, or accessories, making your
                    buying/optimization process simple and seamless.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-6 transition-all duration-500 ease-in-out transform bg-white rounded-lg shadow-sm hover:scale-105 hover:shadow-lg hover:border">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-4 text-base font-medium text-black">
                    Our AI assistant quickly identifies the problem and provides
                    step-by-step guidance for troubleshooting, setup, or
                    connectivity fixes—getting you back on track effortlessly.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-6 transition-all duration-500 ease-in-out transform bg-white rounded-lg shadow-sm hover:scale-105 hover:shadow-lg hover:border">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-4 text-base font-medium text-black">
                    AI chatbots quickly resolve common issues by guiding
                    customers through troubleshooting steps and seamlessly
                    escalating complex cases to human agents with all relevant
                    details.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-6 transition-all duration-500 ease-in-out transform bg-white rounded-lg shadow-sm hover:scale-105 hover:shadow-lg hover:border">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-4 text-base font-medium text-black">
                    AI can automate responses to frequently asked questions,
                    such as product details, shipping times, and return
                    policies, freeing up human agents to handle more complex
                    issues.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-6 transition-all duration-500 ease-in-out transform bg-white rounded-lg shadow-sm hover:scale-105 hover:shadow-lg hover:border">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-4 text-base font-medium text-black">
                    AI can scale effortlessly to handle a large number of
                    customer inquiries simultaneously, especially during peak
                    periods.
                  </p>
                </div>
              </div>
            ...
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-6xl">
              <div className="max-w-2xl mx-auto text-left sm:text-center">
                <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl">
                  Experience the future of electronics support with AI-driven
                  guidance.
                </h2>
