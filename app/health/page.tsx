        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-2xl font-bold leading-tight text-black sm:text-3xl lg:text-3xl animate__animated animate__fadeIn">
              Join Thousands of Happy Customers Transforming Their Health and
              Wellness Journey
            </h2>
          </div>
            ...
            <div className="grid grid-cols-1 gap-12 lg:gap-16 sm:grid-cols-2">
              <div className="flex items-start p-6 transition-all duration-500 ease-in-out transform bg-white rounded-lg shadow-sm hover:scale-105 hover:shadow-lg hover:border">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-4 text-base font-medium text-black">
                    Managing patient inquiries and appointments is easy with our
                    AI assistant, which streamlines communication to provide
                    timely care and lighten staff workloads.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-6 transition-all duration-500 ease-in-out transform bg-white rounded-lg shadow-sm hover:scale-105 hover:shadow-lg hover:border">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-4 text-base font-medium text-black">
                    Say goodbye to scheduling hassles—our AI coordinates
                    appointments based on patient preferences, doctor
                    availability, and clinic capacity for a seamless experience.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-6 transition-all duration-500 ease-in-out transform bg-white rounded-lg shadow-sm hover:scale-105 hover:shadow-lg hover:border">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-4 text-base font-medium text-black">
                    Provide patients with instant, reliable responses to FAQs,
                    from medication instructions to insurance queries, freeing
                    up your team to focus on critical tasks.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-6 transition-all duration-500 ease-in-out transform bg-white rounded-lg shadow-sm hover:scale-105 hover:shadow-lg hover:border">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-4 text-base font-medium text-black">
                    Our AI assists in sending reminders, follow-ups, and
                    personalized health tips, helping patients stay on track
                    with treatments and improving overall outcomes.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-6 transition-all duration-500 ease-in-out transform bg-white rounded-lg shadow-sm hover:scale-105 hover:shadow-lg hover:border">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-4 text-base font-medium text-black">
                    With conversational AI, you can focus on delivering
                    exceptional care while our assistant manages the details,
                    ensuring a smooth experience for both patients and
                    providers.
                  </p>
                </div>
              </div>
        ...
        Experience seamless patient management and enhanced care delivery today.
              ...
              <div className="flex items-center justify-start mt-8 sm:justify-center sm:px-0">
                ...
                <span className="ml-2 text-md font-medium text-gray-600">
                  Your data is completely secured with us. We ensure absolute
                  confidentially.
                </span>
              </div>
            </div>
