  ...
  return (
    <>
          ...
          <div className="lg:w-3/4 pr-4 pl-4 text-center">
            <h1 className="fs-48 fw-600 py-5 text-[#3f559e]">
              ...
              <span className="font-medium text-black">
                {" "}
                Simplify Your Relocation Journey with AI-Driven Legal and HR
                Support
              </span>
            </h1>
            ...
            <div className="grid grid-cols-1 gap-12 sm:grid-cols-2">
              <div className="flex items-start p-6 transition-all duration-500 ease-in-out transform bg-white rounded-lg shadow-sm hover:scale-105 hover:shadow-lg hover:border">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-4 text-base font-medium text-black">
                    Planning to move abroad? Cque AI simplifies the process by
                    collecting your details, suggesting suitable countries, and
                    sharing key prerequisites to get you started stress-free.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-6 transition-all duration-500 ease-in-out transform bg-white rounded-lg shadow-sm hover:scale-105 hover:shadow-lg hover:border">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-4 text-base font-medium text-black">
                    Receive tailored suggestions based on your profile. While AI
                    offers valuable insights, it works alongside expert advice
                    to help you explore your relocation options.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-6 transition-all duration-500 ease-in-out transform bg-white rounded-lg shadow-sm hover:scale-105 hover:shadow-lg hover:border">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-4 text-base font-medium text-black">
                    Cque AI assesses emotional cues during conversations,
                    ensuring every interaction feels encouraging as you plan
                    your move.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-6 transition-all duration-500 ease-in-out transform bg-white rounded-lg shadow-sm hover:scale-105 hover:shadow-lg hover:border">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-4 text-base font-medium text-black">
                    Available 24/7 to answer questions on destinations, visas,
                    and essential preparations, making early planning
                    effortless.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-6 transition-all duration-500 ease-in-out transform bg-white rounded-lg shadow-sm hover:scale-105 hover:shadow-lg hover:border">
                ...
                <div className="ml-5">
                  ...
                  <p className="mt-4 text-base font-medium text-black">
                    Get timely answers to your relocation queries and guidance
                    on the next steps, saving you time and effort.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div
        ...
        style={{ background: "linear-gradient(135deg, #3F559E, #2D4177, #6A86B6, #8A99D8)", width: "90%", maxWidth: "1200px" }}
      >
